  ...
  return (
    <Container className='flex max-w-xl flex-col items-center justify-center'>
      ...
      <div className='my-12 flex items-center justify-center'>
        <div className='space-y-4 rounded-md border border-accent-2 p-6'>
          <div>
            ...
            <div className='space-y-2'>
              ...
              <div className='flex items-center'>
                <input
                  ...
                  onChange={(event) =>
                    setAvoidSimilarChars(event.target.checked)
                  }
                />
          ...
          {password && (
            <div className='space-y-2'>
              ...
              <div className='rounded-md border border-accent-2 p-2 text-xl'>
                {password}
              </div>
            </div>
          )}
